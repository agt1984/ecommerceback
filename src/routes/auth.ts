...
import { login, signup, me } from '../controllers/auth' //Importa la función login desde el archivo '../controllers/auth', lo que significa que se está llamando a esta función cuando se accede a la ruta '/login'.
